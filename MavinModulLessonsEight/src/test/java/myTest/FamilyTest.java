...
public class FamilyTest {
    ...
    public void setFamily1() {
        ...
        pets.add(cat);
        family1 = new Family(mother, father, children,pets);
    ...
    public void testToStringTwo() {
        String expected = "Family{" +
                ...
                ", children=[Human{name='Tom', surname='Karleone', year=1999}, Human{name='Anna', surname='Karleone', year=2001}]" +
                ", pet=[Pet{species=Cat, nickname='Боня', age=4, trickLevel=5, habits=[]}]}";
